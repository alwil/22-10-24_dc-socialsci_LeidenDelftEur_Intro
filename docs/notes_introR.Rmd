...
1. Working directory and project **create a project**: `data-carpentry`

1. Create directories 

1. Explain difference between the console and the script (chat vs email)

1. Create a script: `script.R`  - save in the `scripts` folder 
...
1. Assigning value to an object 
...
1. Discuss the naming rules and conventions
